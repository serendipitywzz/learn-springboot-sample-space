package ink.openmind.springbootsamplecustomerrorpageproject.controller;
 ...
 * @author ：Wangzhuang2
 * @version : 1.0.0
 * @date ：Created in 2020/11/15 22:18
 * DESC
 */
@Controller

/*
* ErrorController是SpringBoot提供的一种错误页面配置方案，使用ErrorController方式较为简单的一种
* 方案。
* */
public class ErrorPageController implements ErrorController {
    ...
    public ResponseEntity<Map<String, Object>> error(HttpServletRequest request){
        ...
        return new ResponseEntity<Map<String, Object>>(body, httpStatus);
    }
